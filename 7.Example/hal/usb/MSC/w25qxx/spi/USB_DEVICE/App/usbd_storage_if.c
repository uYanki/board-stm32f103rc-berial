...
#define STORAGE_BLK_NBR 2048  // sector count = block count * 16
#define STORAGE_BLK_SIZ 4096  // size = 4096 Byte = 4 KB
// capacity = STORAGE_BLK_NBR * STORAGE_BLK_SIZ = 2048 * 4 KB = 8 MB
...
{
  /* USER CODE BEGIN 2 */
    return (W25QXX_Init() == 0) ? (USBD_OK) : (USBD_FAIL);
  /* USER CODE END 2 */
}
