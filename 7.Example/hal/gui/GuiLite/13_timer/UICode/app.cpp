...
class c_clock {
public:
    c_clock() : m_x(80), m_y(64), pi(3.1415926535 / 180) {}
...
class c_weather {
public:
    c_weather() : m_weather_x(16), m_weather_y(46), m_temperature_x(99), m_temperature_y(23), m_humidity_x(96), m_humidity_y(94), m_temp_value_x(144), m_temp_value_y(38), m_humidity_value_x(144), m_humidity_value_y(159), m_day_x(0), m_day_y(25), m_distance(60), m_frame_count(6) {}
    void show()
    {
...
class c_time {
public:
    c_time() : m_x(0), m_y(100), m_width(160), m_height(100), m_time_rect(c_rect(20, 20, 60, 60)) {}
    void show()
    {
        static int count;
        char       time[32];
...
void switchUI()
{
    ...
    switch (index++ % 5) {
        ...
        case 2:
            s_surface->fill_rect(0, 0, UI_WIDTH, 240, 0, Z_ORDER_LEVEL_0);
            clock.set_hands(70.0, 100.0, 0.0, 30.0, 0.0, 2.0, GL_RGB(255, 255, 255), 0.0, 40.0, 0.0, 4.0, GL_RGB(255, 255, 255), 0.0, 60.0, 0.0, 6.0, GL_RGB(237, 125, 124));
            clock.show();
            return;
        case 3:
            clock.set_hands(100.0, 70.0, 30.0, 0.0, 2.0, 0.0, GL_RGB(255, 255, 255), 40.0, 0.0, 4.0, 0.0, GL_RGB(255, 255, 255), 60.0, 0.0, 6.0, 0.0, GL_RGB(237, 125, 124));
            clock.show();
