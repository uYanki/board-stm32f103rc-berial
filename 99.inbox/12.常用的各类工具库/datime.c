...
/*
  YYYY: 1990~1999 2000~2019 90~99 00~19 ==> (?:199\d|20[01]\d|9\d|[01]\d)
    MM: 01~09 10~12 1~9                 ==> (?:0[1-9]|1[0-2]|[1-9])
    DD: 01~09 10~29 30 31 1~9           ==> (?:0[1-9]|[12]\d|3[01]|[1-9])
    注意 MM DD中[1-9]放在最后。正则表达式中的在c语言中特殊字符\需要转义: \\

  YYYY年MM月DD[日]:
  (?:199\d|20[01]\d|9\d|[01]\d)年(?:0[1-9]|1[0-2]|[1-9])月(?:0[1-9]|[12]\d|3[01]|[1-9])日?

  MM月DD日YYYY[年]:
  (?:0[1-9]|1[0-2]|[1-9])月(?:0[1-9]|[12]\d|3[01]|[1-9])日(?:199\d|20[01]\d|9\d|[01]\d)年?
  
  YYYY-MM-DD YYYY/MM/DD YYYY.MM.DD YYYY_MM_DD YYYY MM DD: 
  (?<!\d)(?:199\d|20[01]\d|9\d|[01]\d)(-|/|\.|_| )(?:0[1-9]|1[0-2]|[1-9])\1(?:0[1-9]|[12]\d|3[01]|[1-9])(?!\d)

  MM-DD-YYYY MM/DD/YYYY MM.DD.YYYY MM_DD_YYYY MM DD YYYY:
  (?<!\d)(?:0[1-9]|1[0-2]|[1-9])(-|/|\.|_| )(?:0[1-9]|[12]\d|3[01]|[1-9])\1(?:199\d|20[01]\d|9\d|[01]\d)(?!\d)

  MM DD,YYYY
  (?<!\d)(?:0[1-9]|1[0-2]|[1-9]) (?:0[1-9]|[12]\d|3[01]|[1-9]),(?:199\d|20[01]\d|9\d|[01]\d)(?!\d)

  YYYYMMDD only support: 19990101 20121201 两侧不能为数字
  (?<!\d)(?:199\d|20[01]\d)(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])(?!\d)

  MMDDYYYY only support: 01011999 12012012 两侧不能为数字
  (?<!\d)(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])(?:199\d|20[01]\d)(?!\d)
*/
...
static const struct date DATES[] = {
  {"(?:199\\d|20[01]\\d|9\\d|[01]\\d)年(?:0[1-9]|1[0-2]|[1-9])月(?:0[1-9]|[12]\\d|3[01]|[1-9])日?",0,date_transfer},
  {"(?:0[1-9]|1[0-2]|[1-9])月(?:0[1-9]|[12]\\d|3[01]|[1-9])日(?:199\\d|20[01]\\d|9\\d|[01]\\d)年?", 1,date_transfer},
  {"(?<!\\d)(?:199\\d|20[01]\\d|9\\d|[01]\\d)(-|/|\\.|_| )(?:0[1-9]|1[0-2]|[1-9])\\1(?:0[1-9]|[12]\\d|3[01]|[1-9])(?!\\d)",2,date_transfer},
  {"(?<!\\d)(?:0[1-9]|1[0-2]|[1-9])(-|/|\\.|_| )(?:0[1-9]|[12]\\d|3[01]|[1-9])\\1(?:199\\d|20[01]\\d|9\\d|[01]\\d)(?!\\d)",3,date_transfer},
  {"(?<!\\d)(?:0[1-9]|1[0-2]|[1-9]) (?:0[1-9]|[12]\\d|3[01]|[1-9]),(?:199\\d|20[01]\\d|9\\d|[01]\\d)(?!\\d)",4,date_transfer},
  {"(?<!\\d)(?:199\\d|20[01]\\d)(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\\d|3[01])(?!\\d)",5,date_transfer},
  {"(?<!\\d)(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\\d|3[01])(?:199\\d|20[01]\\d)(?!\\d)",6,date_transfer}
};
